...
import { StudentWallet } from "../../studentWallet/base/StudentWallet";
...
export class TransactionResolverBase {
  ...
  async createTransaction(
    ...
    return await this.service.createTransaction({
      ...
      data: {
        ...
        studentWallet: args.data.studentWallet
          ? {
              connect: args.data.studentWallet,
            }
          : undefined,
      },
    });
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @graphql.ResolveField(() => StudentWallet, {
    nullable: true,
    name: "studentWallet",
  })
  @nestAccessControl.UseRoles({
  ...
  async getStudentWallet(
    ...
    const result = await this.service.getStudentWallet(parent.id);
